...
import { Application, IRouter, NextFunction, Request, RequestHandler, Response, Router } from 'express';

import { classMetadataKey, Controller, ErrorMiddleware, IClassMetadata, IHttpRoute, IMethodMetadata, RouterLib } from './decorators/types';
...
export class Server {
   ...
   */
  public addControllers(controllers: Controller | Controller[], routerLib?: RouterLib, globalMiddleware?: RequestHandler): void {
