...
const LOG = new Logger('AdminMobileChecklistJobItemController.ts');

@Controller('api/mobile/admin/checklist-job-item')
@ClassMiddleware(Authentication.AUTHENTICATED)
@ClassErrorMiddleware(globalErrorHandler)
export class AdminMobileChecklistJobItemController {
