...
const LOG = new Logger('AdminMobileEquipmentController.ts');

@Controller('api/mobile/admin/equipments')
@ClassMiddleware(Authentication.AUTHENTICATED)
@ClassErrorMiddleware(globalErrorHandler)
export class AdminMobileEquipmentController {
  ...
  private async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      await AppLogService.createAppLog(id, `[Mobile] Edit Equipment : ${equipmentId}`);
