...
const LOG = new Logger('MobileJobExpensesItemController.ts');

@Controller('api/mobile/job-expenses-item')
@ClassMiddleware(Authentication.AUTHENTICATED)
@ClassErrorMiddleware(globalErrorHandler)
export class MobileJobExpensesItemController {
  ...
  private async add(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      await AppLogService.createAppLog(id, `[Mobile] Create Job Expenses Item: ${jobExpensesId} - ${itemName}`);
  ...
  private async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      await AppLogService.createAppLog(id, `[Mobile] Edit Job Expenses : ${editedJobExpensesItem.id} - ${itemName}`);
  ...
  private async delete(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      await AppLogService.createAppLog(id, `[Mobile] Delete Job Expenses : ${jobExpensesItemId} - ${itemName}`);
