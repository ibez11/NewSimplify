...
interface Props {
  ...
  handleConfirmAction: (serviceId: number) => void;
...
const BodyRow: FC<Props> = props => {
  ...
  const formattedContactNumber: string = contactNumber ? `${countryCode} ${contactNumber}` : '-';
                    ...
                    {isLoadingData ? (
                      ...
                      <>
                        ...
                        <Typography variant='body2' color='textSecondary'>
                          {<NumberFormat displayType='text' value={formattedContactNumber} format='+###############' />}
                        </Typography>
