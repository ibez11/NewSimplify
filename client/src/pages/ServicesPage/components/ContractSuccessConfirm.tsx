...
const AssignContractButton = withStyles(theme => ({
  root: {
    ...
    <Modal aria-labelledby='modal-title' open={open} disableBackdropClick={true}>
      <Paper className={classes.paper}>
        ...
        <Typography align='center' variant='h4' className={classes.text} gutterBottom>
          Contract Successful Approve!
        </Typography>
        <Typography align='center' variant='body1' className={classes.secondText} gutterBottom>
          Contract for this client already approve, you can assign technician & vehicle for all job(s) in this contract by clicking button Assign
        </Typography>
        <Grid container item justify='center' xs={12} sm={12} md={12} lg={12} xl={12}>
          <Grid xs={12} sm={12} md={12} lg={12} xl={12} className={classes.gridButton}>
            ...
            <AssignContractButton variant='contained' className={classes.viewButton} onClick={handleAssignTechnician}>
              Assign
            </AssignContractButton>
          </Grid>
        </Grid>
      </Paper>
    </Modal>
